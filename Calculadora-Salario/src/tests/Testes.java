...
public class Testes {
    ...
    public void createEmployee() {
        Employee employee = new Employee("Rhaenyra Targaryen", "rhaenyra.targaryen@gmail.com", 2000, Role.DESENVOLVEDOR);
    ...
    public void calculateSalaryDesenvolvedorLessThan3000() {
        Employee employee = new Employee("Rhaenyra Targaryen", "rhaenyra.targaryen@gmail.com", 2999, Role.DESENVOLVEDOR);
